...
{
    public abstract class SkinetWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static SkinetWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(SkinetWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<SkinetDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<SkinetDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<SkinetDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<SkinetDbContext, Task<T>> func)
        {
            T result;
