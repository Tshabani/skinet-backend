...
namespace Skinet.Migrations
{
    ...
    [Migration("20211010195838_Added Domains")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Skinet.Domain.Brand", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Skinet.Domain.Delivery", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Skinet.Domain.ProductType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Skinet.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Skinet.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Skinet.Domain.Product", b =>
                {
                    b.HasOne("Skinet.Domain.Brand", "ProductBrand")
                        .WithMany()
                        .HasForeignKey("ProductBrandId");

                    b.HasOne("Skinet.Domain.ProductType", "ProductType")
                        .WithMany()
